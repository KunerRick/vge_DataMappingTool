...
; (function ($, window, document, undefined) {
	...
	Tree.prototype._subscribeEvents = function () {
		...
		///add method ,right key////
		this.$element.on('mousedown', $.proxy(this._ContextHandler, this));
	...
	*/
	...
	Tree.prototype._ContextHandler = function (event) {
	...
	Tree.prototype._toggleSelected = function (node, options) {
		...
		this._setSelected(node, true, options);   //点击不切换选中状态
